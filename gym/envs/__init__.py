...
# added
register(
    id='InvertedPendulumDynamic-v1',
    entry_point='gym.envs.mujoco:InvertedPendulumDynamicEnv',
    max_episode_steps=1000,
    reward_threshold=950.0,
)
...
register(
    id='HalfCheetahDynamic-v1',
    entry_point='gym.envs.mujoco:HalfCheetahDynamicEnv',
    max_episode_steps=1000,
    reward_threshold=4800.0,
)
...
register(
    id='HopperDynamic-v1',
    entry_point='gym.envs.mujoco:HopperDynamicEnv',
    max_episode_steps=1000,
    reward_threshold=3800.0,
)
...
register(
    id='Walker2dDynamic-v1',
    max_episode_steps=1000,
    entry_point='gym.envs.mujoco:Walker2dDynamicEnv',
)
