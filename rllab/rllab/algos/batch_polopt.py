...
class BatchSampler(BaseSampler):
    ...
    def obtain_samples(self, itr):
        ...
        paths = parallel_sampler.sample_paths(
            ...
            curriculum=self.algo.curriculum,
...
class BatchPolopt(RLAlgorithm):
    ...
    def __init__(
            ...
            sampler_cls=None,
            sampler_args=None,
            plot_learning_curve=False,  # added
            trial=-1,  # added
            num_workers=1,  # added
            use_num_paths=False,  # added
            **kwargs
    ):
        """
        ...
        :param n_workers: number of samplers
        :param use_num_paths: if True, samples refer to number of trajectories to collect, not samples
        """
        self.env = env
        self.policy = policy
        ...
        self.use_num_paths = use_num_paths
        ...
        for itr in range(self.current_itr, self.n_itr):
            ...
            with logger.prefix('itr #%d | ' % itr):
                ...
                if self.plot_learning_curve:
                    ...
                    total_returns = [sum(path["rewards"]) for path in cur_paths]
