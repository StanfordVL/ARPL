...
"""
This class implements an adversarial Gaussian MLP Policy.
"""


# TODO: implement curriculum policy, have additional param, vec of probs in order, need additional methods to
# TODO: add into active set, sample, etc -> rollout needs to check for this policy too, as does batch_polopt

class AdversarialPolicy(StochasticPolicy, LasagnePowered, Serializable):
    def __init__(
            self,
            env_spec,
